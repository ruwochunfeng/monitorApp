 ...
 */
public class SpeedControl extends View {
    ...
    public SpeedControl(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mPadding = Math.min(
                ...
                Math.min(getPaddingRight(), getPaddingBottom())
        );
