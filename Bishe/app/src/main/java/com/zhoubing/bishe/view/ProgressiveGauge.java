...
import com.zhoubing.bishe.view.LinearGauge;
...
public class ProgressiveGauge extends LinearGauge {
    ...
    private void initAttributeSet(Context context, AttributeSet attrs) {
        if (attrs == null)
            return;
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, com.github.anastr.speedviewlib.R.styleable.LinearGauge, 0, 0);

        frontPaint.setColor(a.getColor(com.github.anastr.speedviewlib.R.styleable.LinearGauge_sv_speedometerColor, frontPaint.getColor()));
        backPaint.setColor(a.getColor(com.github.anastr.speedviewlib.R.styleable.LinearGauge_sv_speedometerBackColor, backPaint.getColor()));
        a.recycle();
    }
...
//                , getWidthPa(), 0f);
        ...
        path.lineTo(getWidthPa(),getHeightPa() - getHeightPa() *.1f);
    ...
    protected void updateVerticalPath() {
        path.reset();
        path.moveTo(0f, getHeightPa());
//        path.addArc(0f,getHeightPa()+getWidthPa()*0.1f/2,getWidthPa()*.1f,getHeightPa()-getWidthPa()*0.1f/2,180,0);
        path.lineTo(getWidthPa() *.1f, getHeightPa());
        path.lineTo(getWidthPa() *.1f,0f);
        path.lineTo(0f, 0f);
//        path.addArc(0f,getWidthPa()*0.1f/2,getWidthPa()*.1f,-getWidthPa()*0.1f/2,0,360);
        path.lineTo(0f, getHeightPa());
    }
