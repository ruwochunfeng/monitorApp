...
import com.zhoubing.bishe.util.OnSectionChangeListener;
import com.zhoubing.bishe.util.OnSpeedChangeListener;
...
public abstract class Gauge extends View {
    ...
    private void initAttributeSet(Context context, AttributeSet attrs) {
        if (attrs == null)
            return;
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, com.github.anastr.speedviewlib.R.styleable.Gauge, 0, 0);

        maxSpeed = a.getInt(com.github.anastr.speedviewlib.R.styleable.Gauge_sv_maxSpeed, maxSpeed);
        minSpeed = a.getInt(com.github.anastr.speedviewlib.R.styleable.Gauge_sv_minSpeed, minSpeed);
        withTremble = a.getBoolean(com.github.anastr.speedviewlib.R.styleable.Gauge_sv_withTremble, withTremble);
        textPaint.setColor(a.getColor(com.github.anastr.speedviewlib.R.styleable.Gauge_sv_textColor, textPaint.getColor()));
        textPaint.setTextSize(a.getDimension(com.github.anastr.speedviewlib.R.styleable.Gauge_sv_textSize, textPaint.getTextSize()));
        speedTextPaint.setColor(a.getColor(com.github.anastr.speedviewlib.R.styleable.Gauge_sv_speedTextColor, speedTextPaint.getColor()));
        speedTextPaint.setTextSize(a.getDimension(com.github.anastr.speedviewlib.R.styleable.Gauge_sv_speedTextSize, speedTextPaint.getTextSize()));
        unitTextPaint.setColor(a.getColor(com.github.anastr.speedviewlib.R.styleable.Gauge_sv_unitTextColor, unitTextPaint.getColor()));
        unitTextPaint.setTextSize(a.getDimension(com.github.anastr.speedviewlib.R.styleable.Gauge_sv_unitTextSize, unitTextPaint.getTextSize()));
        String unit = a.getString(com.github.anastr.speedviewlib.R.styleable.Gauge_sv_unit);
        this.unit =  (unit != null) ? unit : this.unit;
        trembleDegree = a.getFloat(com.github.anastr.speedviewlib.R.styleable.Gauge_sv_trembleDegree, trembleDegree);
        trembleDuration = a.getInt(com.github.anastr.speedviewlib.R.styleable.Gauge_sv_trembleDuration, trembleDuration);
        lowSpeedPercent = a.getInt(com.github.anastr.speedviewlib.R.styleable.Gauge_sv_lowSpeedPercent, lowSpeedPercent);
        mediumSpeedPercent = a.getInt(com.github.anastr.speedviewlib.R.styleable.Gauge_sv_mediumSpeedPercent, mediumSpeedPercent);
        speedometerTextRightToLeft = a.getBoolean(com.github.anastr.speedviewlib.R.styleable.Gauge_sv_textRightToLeft, speedometerTextRightToLeft);
        accelerate = a.getFloat(com.github.anastr.speedviewlib.R.styleable.Gauge_sv_accelerate, accelerate);
        decelerate = a.getFloat(com.github.anastr.speedviewlib.R.styleable.Gauge_sv_decelerate, decelerate);
        unitUnderSpeedText = a.getBoolean(com.github.anastr.speedviewlib.R.styleable.Gauge_sv_unitUnderSpeedText, unitUnderSpeedText);
        unitSpeedInterval = a.getDimension(com.github.anastr.speedviewlib.R.styleable.Gauge_sv_unitSpeedInterval, unitSpeedInterval);
        speedTextPadding = a.getDimension(com.github.anastr.speedviewlib.R.styleable.Gauge_sv_speedTextPadding, speedTextPadding);
        String speedTypefacePath = a.getString(com.github.anastr.speedviewlib.R.styleable.Gauge_sv_speedTextTypeface);
        if (speedTypefacePath != null)
            setSpeedTextTypeface(Typeface.createFromAsset(getContext().getAssets(), speedTypefacePath));
        String typefacePath = a.getString(com.github.anastr.speedviewlib.R.styleable.Gauge_sv_textTypeface);
        if (typefacePath != null)
            setTextTypeface(Typeface.createFromAsset(getContext().getAssets(), typefacePath));
        int position = a.getInt(com.github.anastr.speedviewlib.R.styleable.Gauge_sv_speedTextPosition, -1);
        if (position != -1)
            setSpeedTextPosition(Position.values()[position]);
        byte format = (byte) a.getInt(com.github.anastr.speedviewlib.R.styleable.Gauge_sv_speedTextFormat, -1);
        if (format != -1)
    ...
    protected RectF getSpeedUnitTextBounds() {
        float left = getWidthPa()*speedTextPosition.x -translatedDx + padding
                ...
                + speedTextPadding*speedTextPosition.paddingH-50;
