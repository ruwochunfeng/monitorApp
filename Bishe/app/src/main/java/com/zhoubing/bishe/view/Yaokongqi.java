...
public class Yaokongqi extends CustomView{
    ...
    Paint Jiting;
    //0x444E5268
    int mDefauColor = 0x00ffffff;
    int mTouchedColor = 0xFFDF9C81;


    public Yaokongqi(Context context) {
        this(context, null);
    }

    public Yaokongqi(Context context, AttributeSet attrs) {
        super(context, attrs);
